...
const links = [
  ...
  { title: "Blog", url: "https://example.com", icon: "✏️" },
];
...
export default function Home() {
  return (
    <div className="relative flex min-h-dvh flex-1 flex-col items-center overflow-hidden bg-[#0d0d0d]">
      ...
      <main className="relative z-10 mx-auto flex w-full max-w-md flex-col items-center px-6 pb-24 pt-40">
        {/* 원형 프로필 사진 */}
        <div className="h-28 w-28 overflow-hidden rounded-full shadow-lg shadow-black/50 ring-4 ring-white/80">
          {profile.avatarUrl ? (
